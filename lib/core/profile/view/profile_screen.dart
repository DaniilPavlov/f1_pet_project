  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListTile(
      ...
      onTap: () async {
        ...
        final prefs = ref.read(notificationsPreferenceStateHolderProvider);
        if (prefs.effectivelyEnabled) {
          await ref.read(notificationsPreferenceManagerProvider).resync(
...
class _NotificationsRow extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final prefs = ref.watch(notificationsPreferenceStateHolderProvider);
    ...
    final manager = ref.watch(notificationsPreferenceManagerProvider);
      ...
      children: [
        ...
        SwitchListTile(
          ...
          onChanged: !canTogglePractice
              ? null
              : (value) => manager.setPracticeRemindersEnabled(
                    enabled: value,
                    locale: locale,
                  ),
        ),
