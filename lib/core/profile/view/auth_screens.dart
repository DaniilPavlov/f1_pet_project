...
class _AuthForm extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final viewModel = ref.watch(authPageStateHolderProvider);
    final manager = ref.watch(authPageManagerProvider);
    final error = authErrorMessage(context.l10n, viewModel.errorKey);
            ...
            CustomTextField(
              ...
              onSubmit: loading
                  ...
                  : (_) async {
                      ...
                      final ok = isRegister ? await manager.register() : await manager.signIn();
              ...
              Align(
                ...
                child: TextButton(
                  onPressed: loading
                      ...
                      : () async {
                          FocusScope.of(context).unfocus();
                          final ok = await manager.sendPasswordReset();
                          if (!context.mounted) {
                            return;
                          }
                          if (ok) {
