...
class _ScheduleScreenState extends ConsumerState<ScheduleScreen> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => ref.read(schedulePageManagerProvider).loadAllData());
  }

  @override
  Widget build(BuildContext context) {
    final viewModel = ref.watch(schedulePageStateHolderProvider);
    final manager = ref.watch(schedulePageManagerProvider);
        ...
        child: OnAppResumed(
          ...
          child: Builder(
            builder: (context) {
              ...
              final upcoming = viewModel.upcomingRace;
                  ...
                  slivers: [
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: CustomCalendar(
                          imagePathCallback: manager.getLogoPath,
                          onDaySelected: manager.onSelectDay,
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: viewModel.selectedDayHasSessions
                            ? _SelectedDaySchedule(selectedDay: viewModel.selectedDay)
                            : upcoming == null
                            ? const SizedBox.shrink()
                            : ScheduleRaceFeaturedCard(
                                race: upcoming,
                                countdown: viewModel.upcomingCountdown,
                                showCountdown: true,
