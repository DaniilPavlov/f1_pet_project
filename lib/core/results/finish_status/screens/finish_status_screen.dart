...
class _FinishStatusScreenState extends ConsumerState<FinishStatusScreen> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => ref.read(finishStatusScreenControllerProvider.notifier).bootstrap());
  }

  @override
  Widget build(BuildContext context) {
    final state = ref.watch(finishStatusScreenControllerProvider);
    final controller = ref.read(finishStatusScreenControllerProvider.notifier);
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (state.statuses.isLoading)
                      ...
                      else if (state.statuses.isError)
                        ErrorBody(
                        ...
                        _StatusList(items: state.statuses.value ?? const []),
                    ],
                  ),
                ),
              ),
