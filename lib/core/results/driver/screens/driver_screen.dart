...
class _DriverScreenState extends ConsumerState<DriverScreen> {
  late final DriverScreenArgs _args;

  @override
  void initState() {
    super.initState();
    _args = DriverScreenArgs(driver: widget.driver, currentConstructors: widget.currentConstructors);
    ...
    Future.microtask(() {
      ...
      return ref.read(driverScreenControllerProvider(_args).notifier).loadAll();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final state = ref.watch(driverScreenControllerProvider(_args));
    final controller = ref.read(driverScreenControllerProvider(_args).notifier);
