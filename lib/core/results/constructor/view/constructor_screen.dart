...
class _ConstructorScreenState extends ConsumerState<ConstructorScreen> {
  late final ConstructorPageArgs _args;

  @override
  void initState() {
    super.initState();
    _args = ConstructorPageArgs(
    ...
    Future.microtask(() {
      ...
      return ref.read(constructorPageManagerProvider(_args)).loadAll();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final viewModel = ref.watch(constructorPageStateHolderProvider(_args));
    final manager = ref.watch(constructorPageManagerProvider(_args));
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          EspnDriverNewsSection(news: viewModel.news),
                        ],
                      ),
                    ),
                  ),
