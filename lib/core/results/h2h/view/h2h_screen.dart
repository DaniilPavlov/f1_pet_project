...
class _H2hViewState extends ConsumerState<H2hView> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => ref.read(h2hPageManagerProvider(widget.initialMode)).bootstrap());
  }

  @override
  Widget build(BuildContext context) {
    final mode = widget.initialMode;
    final viewModel = ref.watch(h2hPageStateHolderProvider(mode));
    final manager = ref.watch(h2hPageManagerProvider(mode));
    final isDrivers = viewModel.isDriversMode;
                ...
                child: Column(
                  ...
                  children: [
                    SegmentedButton<H2hMode>(
                      ...
                      onSelectionChanged: (value) => manager.setMode(value.first),
                    ),
                    ...
                    const SizedBox(height: 16),
                    H2hFiltersCard(
                      scopeMode: viewModel.scopeMode,
                      useCurrentSeason: viewModel.useCurrentSeason,
                      currentEntitiesOnly: viewModel.currentEntitiesOnly,
                      isSeasonScope: viewModel.isSeasonScope,
                      showYearPicker: viewModel.showYearPicker,
                      latestSeason: viewModel.latestSeason,
                      yearController: manager.yearController,
                      ...
                      onScopeModeChanged: manager.setScopeMode,
                      onUseCurrentSeasonChanged: manager.setUseCurrentSeason,
                      onCurrentEntitiesOnlyChanged: manager.setCurrentEntitiesOnly,
                      onSeasonChanged: manager.onSeasonChanged,
                    ),
                    const SizedBox(height: 20),
                    if (isDrivers) ...[
                      DriverPickerField(
                        label: context.l10n.h2hDriverA,
                        driver: viewModel.driverA,
                        onChanged: manager.setDriverA,
                        loadDrivers: manager.loadDriversForPicker,
                        enableSearch: !viewModel.currentEntitiesOnly,
                      ),
                      const SizedBox(height: 12),
                      DriverPickerField(
                        label: context.l10n.h2hDriverB,
                        driver: viewModel.driverB,
                        onChanged: manager.setDriverB,
                        loadDrivers: manager.loadDriversForPicker,
                        enableSearch: !viewModel.currentEntitiesOnly,
                      ),
                    ] else ...[
                      ConstructorPickerField(
                        ...
                        constructor: viewModel.constructorA,
                        onChanged: manager.setConstructorA,
                        loadConstructors: manager.loadConstructorsForPicker,
                        enableSearch: !viewModel.currentEntitiesOnly,
                      ),
                      const SizedBox(height: 12),
                      ConstructorPickerField(
                        label: context.l10n.h2hConstructorB,
                        constructor: viewModel.constructorB,
                        onChanged: manager.setConstructorB,
                        loadConstructors: manager.loadConstructorsForPicker,
                        enableSearch: !viewModel.currentEntitiesOnly,
                      ),
                    ],
                    ...
                    BlackButton(
                      ...
                      isDisabled: !manager.canCompare || comparison.isLoading,
                      onTap: manager.compare,
                    ),
                    ...
                    if (comparison.isLoading)
                      ...
                      ErrorBody(
                        onTap: manager.refreshComparison,
