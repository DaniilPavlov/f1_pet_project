...
class HomeHeadlinesSection extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              ..._body(
                context: context,
                articles: articles,
                visible: controller.visibleArticles,
                isLoading: articles == null && controller.articles.isLoading,
                isError: controller.articles.isError && articles == null,
                locale: locale,
              ),
            ],
          ),
