...
mixin _$SeasonModel {
 ...
 String get season; String get url;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SeasonModel&&(identical(other.season, season) || other.season == season)&&(identical(other.url, url) || other.url == url));
}
...
@override
String toString() {
  return 'SeasonModel(season: $season, url: $url)';
}
...
/// Create a copy of SeasonModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? season = null,Object? url = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String season,  String url)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SeasonModel() when $default != null:
return $default(_that.season,_that.url);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String season,  String url)  $default,) {final _that = this;
switch (_that) {
case _SeasonModel():
return $default(_that.season,_that.url);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String season,  String url)?  $default,) {final _that = this;
switch (_that) {
case _SeasonModel() when $default != null:
return $default(_that.season,_that.url);case _:
  return null;
...
class _SeasonModel implements SeasonModel {
  const _SeasonModel({required this.season, required this.url});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SeasonModel&&(identical(other.season, season) || other.season == season)&&(identical(other.url, url) || other.url == url));
}
...
/// Create a copy of SeasonModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? season = null,Object? url = null,}) {
