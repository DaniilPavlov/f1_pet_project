...
class WikipediaPageImageRepository {
  WikipediaPageImageRepository({Dio? dio})
    : _dio = dio ?? AppDio.external(headers: {'User-Agent': StaticData.wikipediaUserAgent});
  ...
  Future<String?> _fetch(String host, String title, int thumbSize) async {
    try {
      ...
      logger.e('WikipediaPageImageRepository failed', error: error, stackTrace: stackTrace);
      return null;
    }
  }
